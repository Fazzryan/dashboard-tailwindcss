<div class="fixed inset-y-0 left-0 z-40 flex flex-col w-64 transition-transform duration-300 ease-in-out transform bg-white shadow-xl lg:relative lg:translate-x-0"
    ...
    <!-- Logo -->
    <div class="flex items-center justify-between h-16 px-6 bg-gradient-to-r from-primary-600 to-primary-400">
    ...
    @php
        $active = 'bg-primary-50 text-primary-400 border border-primary-200';
        $inactive = 'text-gray-600 hover:text-primary-400 hover:bg-primary-50';
    @endphp
    <!-- Navigation Menu -->
    <nav class="flex-1 px-3 mt-6 overflow-y-auto">
        <div class="space-y-2">
            ...
            <a href="{{ route('be.projects.index') }}"
                class="flex items-center px-3 py-3 text-sm font-medium transition-all duration-200 group rounded-xl {{ request()->routeIs('be.projects.index') ? $active : $inactive }}">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <!-- Report -->
            <a href="#"
                class="flex items-center px-3 py-3 text-sm font-medium text-gray-600 transition-all duration-200 group hover:text-primary-600 hover:bg-primary-50 rounded-xl">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="p-4 mt-auto border-t border-gray-100">
        <div class="flex items-center space-x-3">
            <div
                class="flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-r from-primary-500 to-primary-300">
